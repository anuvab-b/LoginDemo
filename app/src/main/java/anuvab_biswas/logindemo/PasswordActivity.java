                ...
                else
                {
                    firebaseAuth.sendPasswordResetEmail(useremail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            else//works when user hasn't registered correct email ID.
                            {
                                Toast.makeText(PasswordActivity.this,"ERROR.Password reset email not sent",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
